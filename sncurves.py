...
SNCurves.append(__Params("HS", seawater=False, cp=False, N=2e6, m1=4.7, loga1=17.446, m2=None, loga2=None, k=0.25))
SNCurves.append(__Params("HS", seawater=True, cp=True, N=2e6, m1=4.7, loga1=17.446, m2=4.7, loga2=17.446, k=0.25))
